...
class create_bot(GAS_class):
    ...
    def dead(self):
        if self.health > 0:
            ...
            if self.game_width - self.boundary_size > self.position[0] > self.boundary_size and self.game_height - self.boundary_size > \
                    self.position[1] > self.boundary_size:
